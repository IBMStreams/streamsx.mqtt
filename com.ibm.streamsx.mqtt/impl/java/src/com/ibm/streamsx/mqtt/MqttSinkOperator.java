 ...
 */
@PrimitiveOperator(name="MQTTSink", namespace="com.ibm.streamsx.mqtt",
...
public class MqttSinkOperator extends AbstractMqttOperator implements StateHandler{
	...
	private static final String CLASS_NAME = "com.ibm.streamsx.mqtt.MqttSinkOperator"; //$NON-NLS-1$
